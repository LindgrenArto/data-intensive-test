...
public partial class DataIntensiveDatabase2Context : DbContext
{
    public DataIntensiveDatabase2Context(DbContextOptions<DataIntensiveDatabase2Context> options)
        : base(options)
    {
    }
